...
plt.xscale("log")
titre = algo +' - Time per MB vs Sample Size for Compress Command'
plt.title(titre)
...
plt.ylabel('Time per MB (seconds)')
plt.xscale("log")
titre = algo +' - Time per MB vs Sample Size for Decompress Command'
plt.title(titre)
plt.legend(title='Chromosomes',bbox_to_anchor=(1.2, 1.1))
plt.grid(True)
plt.savefig("E:\VM_data\Git\VCF_compression_benchmarking\Images\\" + titre, bbox_inches='tight')
...
if algo == "GSC":
    ...
    plt.ylabel('Time per MB (seconds)')
    plt.xscale("log")
    titre = algo +' - Time per MB vs Sample Size for Compress Command (bis)'
    plt.title(titre)
    ...
    plt.ylabel('Time per MB (seconds)')
    plt.xscale("log")
    titre = algo +' - Time per MB vs Sample Size for Decompress Command (bis)'
    plt.title(titre)
    plt.legend(title='Chromosomes')#,bbox_to_anchor=(1.21, 1))
    plt.grid(True)
    plt.savefig("E:\VM_data\Git\VCF_compression_benchmarking\Images\\" + titre, bbox_inches='tight')
    ...
    plt.xscale("log")
    titre = algo +' - Time vs Sample Size for Decompress_One_Sample Command'
    plt.title(titre)
    plt.legend(title='Chromosomes')#,bbox_to_anchor=(1.21, 1))
    plt.grid(True)
    plt.savefig("E:\VM_data\Git\VCF_compression_benchmarking\Images\\" + titre, bbox_inches='tight')
    ...
    titre = algo +' - Time per MB vs Sample Size for Random Access Command (bis)'
    plt.title(titre)
    plt.legend(title='Chromosomes')#,bbox_to_anchor=(1.21, 1))
    plt.grid(True)
    plt.savefig("E:\VM_data\Git\VCF_compression_benchmarking\Images\\" + titre, bbox_inches='tight')
